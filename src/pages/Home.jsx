    ...
    return (
        <div className="min-h-screen relative overflow-x-hidden bg-[#050505] text-white">
            ...
            <nav className={`fixed top-0 left-0 w-full z-50 transition-all duration-500 ${scrolled ? 'glass py-3' : 'bg-transparent py-6'}`}>
                <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
                    ...
                    <div className="hidden md:flex items-center gap-8">
                        ...
                        <a href="/portfolio" target="_blank" rel="noopener noreferrer" className="text-xs font-bold hover:text-blue-400 transition-colors uppercase tracking-[0.3em]">Portfolio</a>
            ...
            <AnimatePresence>
                {isMenuOpen && (
                    ...
                    >
                        ...
                        <a href="/portfolio" target="_blank" rel="noopener noreferrer" onClick={() => setIsMenuOpen(false)} className="text-4xl font-bold font-heading uppercase tracking-widest">Portfolio</a>
            ...
            <main className="relative z-10 pt-20">
                ...
                {/* Portfolio Section - Renamed to Archive to avoid duplicate name maybe, or keep simpler */}
